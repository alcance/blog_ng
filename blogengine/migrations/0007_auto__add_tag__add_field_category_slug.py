...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'blogengine_post_tag')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'blogengine_post_tag'))
    ...
    models = {
        ...
        u'blogengine.post': {
            ...
            'tag': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['blogengine.Tag']", 'null': 'True', 'blank': 'True'}),
