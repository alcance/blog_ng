...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blogengine_category', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=40, unique=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'blogengine.category': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '40', 'unique': 'True', 'null': 'True'})
        },
        u'blogengine.post': {
